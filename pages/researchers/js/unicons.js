! function(t) {
    ...
    var n = function(t) {
        ...
        return d.prototype = b.constructor = v, v.constructor = d, v[c] = d.displayName = "GeneratorFunction", t.isGeneratorFunction = function(t) {
            var r = "function" == typeof t && t.constructor;
            return !!r && (r === d || "GeneratorFunction" === (r.displayName || r.name))
        }, t.mark = function(t) {
            return Object.setPrototypeOf ? Object.setPrototypeOf(t, v) : (t.__proto__ = v, c in t || (t[c] = "GeneratorFunction")), t.prototype = Object.create(b), t
        }, t.awrap = function(t) {
            return {
                __await: t
            }
        ...
        }, L(b), b[c] = "Generator", b[i] = function() {
            return this
        }, b.toString = function() {
                ...
                fetch("".concat(e).concat(t, ".svg")).then((function(t) {
                    ...
                    return function(t, r) {
                        for (var n = document.getElementsByClassName("".concat("uim-").concat(t)); n.length > 0;) {
                            ...
                            i.innerHTML = r, i.classList.add("uim-svg"), i.firstChild.setAttribute("width", "1em"), i.style.cssText = o.style.cssText, o.classList.contains("uim-white") && (i.style.mask = "url(".concat(e).concat(t, ".svg)"), i.style.webkitMask = "url(".concat(e).concat(t, ".svg)"), i.style.background = "white"), o.replaceWith(i)
                        }
                    }(t, r)
                }))
            }))
        ...
        o = function() {
            ...
            for (var e = 0; e < t.length; e++) {
                t[e].classList.forEach((function(t) {
                    if (t.indexOf("uim-") > -1) {
                        var e = t.toLocaleLowerCase().replace("uim-", ""); - 1 === r.indexOf(e) && r.push(e)
                    }
                }))
            }
            n(r)
